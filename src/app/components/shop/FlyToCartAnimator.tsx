...
export default function FlyToCartAnimator() {
  const { flyAnimation, completeFlyAnimation } = useShopCart();
  ...
  useEffect(() => {
    ...
    if (!cartRect) completeFlyAnimation();
  ...
  const { product, fromRect, variant } = flyAnimation;
