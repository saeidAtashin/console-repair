    ...
    <div className="mt-10 grid gap-4 grid-cols-3">
      {features.map((item, i) => {
        ...
        return (
          <div
            key={i}
            className="group relative flex items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.04] px-5 py-4 text-zinc-300 backdrop-blur-xl transition duration-300 hover:border-cyan-400/40 hover:bg-white/[0.06]"
          >
