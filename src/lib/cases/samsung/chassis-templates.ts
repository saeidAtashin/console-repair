...
export const CHASSIS_TEMPLATES: Record<string, ChassisTemplate> = {
  ...
  "galaxy-s21-fe-triple": {
    slug: "galaxy-s21-fe-triple",
    cornerRadiusRatio: 0.14,
    camera: {
      module: { x: 0.055, y: 0.028, width: 0.38, height: 0.12, cornerRadius: 0.045 },
      lenses: [
        { cx: 0.13, cy: 0.065, r: 0.032 },
        { cx: 0.24, cy: 0.065, r: 0.032 },
        { cx: 0.35, cy: 0.065, r: 0.032 },
      ],
      flash: { x: 0.38, y: 0.052, width: 0.032, height: 0.032 },
    },
    printSafeInsetRatio: EDGE_INSET,
  },
